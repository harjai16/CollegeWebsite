...
function captcha_create_image() {
	...
	$color_text = imagecolorallocate($image, 55, 41, 153);
	$color_background = imagecolorallocate($image, 250, 240, 250);
