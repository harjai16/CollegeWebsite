...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2022 at 10:17 AM
...
CREATE TABLE `application` (
  `id` int(11) NOT NULL,
  `student_pic` varchar(200) NOT NULL,
  ...
  `paddress1` varchar(200) NOT NULL,
  `paddress2` varchar(200) NOT NULL,
  `paddress3` varchar(200) NOT NULL,
...
CREATE TABLE `feedback` (
  ...
  `feedbackdata` varchar(200) NOT NULL,
...
(1, 'mayank@gmail.com', 'Admin', 'Sir ', 'Please upload this', ' '),
(2, 'Admin', 'mayank@gmail.com', '', 'Ok mayank', ''),
(3, 'mayank@gmail.com', 'Admin', 'Please donate ', 'Thanks ', ' '),
(4, 'sauravchaudhary774@gmail.com', 'Admin', 'Hello sir', 'Hello sir i am saurav', ' '),
(5, 'Admin', 'sauravchaudhary774@gmail.com', '', 'Yes saurav I know you', ''),
(6, 'sauravchaudhary774@gmail.com', 'Admin', 'Hello', 'Hello', ' '),
(7, 'sauravchaudhary774@gmail.com', 'Admin', 'help', 'please  help\r\n', ' '),
(8, 'Admin', 'sauravchaudhary774@gmail.com', '', 'ok i mention', '');
...
CREATE TABLE `notification` (
  `id` int(11) NOT NULL,
  `notiuser` varchar(200) NOT NULL,
  `notireciver` varchar(200) NOT NULL,
  `notitype` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'mayank@gmail.com', 'Admin', 'Send Feedback'),
(2, 'Admin', 'mayank@gmail.com', 'Send Message'),
(3, 'mayank@gmail.com', 'Admin', 'Send Feedback'),
(4, 'sauravchaudhary774@gmail.com', 'Admin', 'Send Feedback'),
(5, 'Admin', 'sauravchaudhary774@gmail.com', 'Send Message'),
(6, 'sauravchaudhary774@gmail.com', 'Admin', 'Send Feedback'),
(7, 'sauravchaudhary774@gmail.com', 'Admin', 'Send Feedback'),
(8, 'Admin', 'sauravchaudhary774@gmail.com', 'Send Message');
...
(10, '16', 'Bachelor of Science', 'PHYSICS', 'CHEMESTRY', 'MATH', '2022-02-03 14:15:11', NULL),
(12, '18', 'Diploma in Computer Application', 'JAVA', 'PHP', 'CSS', '2022-02-05 01:35:32', NULL),
(13, '21', 'computer', 's', 'd', 't', '2022-02-09 13:44:43', NULL);
...
(5, 'Admission Notice', 'This is Admission Notice please fill the correct data', '2022-02-03 14:12:42'),
(8, 'hii', 'Hello', '2022-02-09 08:20:44');
...
(18, 'DIPLOMA', 'Diploma in Computer Application', '03-02-2022', NULL),
(19, 'BA', 'Bachelor of Arts', '03-02-2022', NULL),
(20, 'Fashion Designing', 'Fashion Designer', '03-02-2022', NULL),
(21, 'Btechhh', 'computer', '09-02-2022', '09-02-2022');
...
(2, 'Saurav', 'Chaudhary', 'sauravchaudhary774@gmail.com', 851912911, '$2y$10$I/cDGfWub/H.rz1Syjfp7.fQ1Rj.0i7rgJYzQPsOyfRKT.Rt47Oqi', 'SIET3123', 'India', 'New Delhi', '0', 'verified', '0', '2022-02-05 17:50:21'),
(4, 'Mayank', 'Kumar', 'mayank@gmail.com', 9899856457, '$2y$10$xcnaiAanrRS875kz3v1Nj.lujlKmNacFZ2a/34KK5.GxUqY1yDv.m', 'SIETA3624E', 'India', 'Bihar', '0', 'verified', '', '2022-02-06 11:38:23');
